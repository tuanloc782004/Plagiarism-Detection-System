		...
		<div class="nav-container">
			...
			<ul class="nav-menu" id="nav-menu">
				...
				<li><a href="UploadEssayServlet" class="nav-link">📥 Nộp
						bài</a></li>
				<li><a href="EssayListServlet" class="nav-link">📄 Danh
						sách bài</a></li>
				<c:choose>
		...
		<section class="hero">
			<div class="hero-content">
				...
				<div class="hero-buttons">
					<a href="upload.jsp" class="btn btn-primary"> 📥 Nộp bài ngay </a>
					<a href="essay_list.jsp" class="btn btn-secondary"> 📄 Xem bài
						đã nộp </a>
				</div>
			</div>
